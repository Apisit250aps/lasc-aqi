        ...
        <div className="container mx-auto px-4">
          <div className="flex-1">
            <h1 className="text-2xl font-bold flex items-center">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">AQI Monitor</span>
            </h1>
          </div>
          <div className="flex-none">
            <span className="badge badge-outline">{currentData.deviceData?.name || deviceId}</span>
            <button onClick={refreshData} className="btn btn-square btn-ghost ml-2">
        ...
        <div className="flex flex-col space-y-4 lg:flex-row lg:space-y-0 lg:space-x-4 mb-6">
          ...
          <div className="card w-full lg:w-1/3 glass shadow-xl overflow-hidden">
            <div className={`absolute inset-0 bg-gradient-to-br opacity-30 ${
              aqiLevel === 'Good' ? 'from-green-500 to-green-700' :
              aqiLevel === 'Moderate' ? 'from-yellow-500 to-yellow-700' :
              aqiLevel === 'Unhealthy for Sensitive Groups' ? 'from-orange-500 to-orange-700' :
              aqiLevel === 'Unhealthy' ? 'from-red-500 to-red-700' :
              aqiLevel === 'Very Unhealthy' ? 'from-purple-500 to-purple-700' :
            ...
            <div className="card-body z-10 p-6 flex flex-col items-center justify-center">
              ...
              <div className="mt-4 text-center">
                <div className={`text-xl font-bold ${aqiColorClass}`}>{aqiStatus}</div>
                <div className={`badge badge-lg mt-2 ${aqiStatusBadgeClass}`}>{aqiLevel}</div>
              </div>
              <div className="text-sm text-base-content/70 mt-2">Updated: {formatTime(currentData.updatedAt)}</div>
            </div>
          </div>
          ...
          <div className="card w-full lg:w-2/3 bg-base-100 shadow-xl">
            <div className="card-body p-6">
              ...
              <div className={`h-64 ${activeTab === 'pm' ? 'block' : 'hidden'}`}>
                <Line 
                  data={getPMChartData()}
              ...
              <div className={`h-64 ${activeTab === 'temp' ? 'block' : 'hidden'}`}>
                <Line 
                  data={getTHChartData()}
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body p-4 text-center">
              ...
              <div className="flex items-center justify-center my-2">
                <i className="bx bx-thermometer text-3xl text-orange-500"></i>
              </div>
              <div className="stat-value text-2xl">{currentData.temperature}°C</div>
            </div>
          </div>
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body p-4 text-center">
                  ...
                  {historicalData.map((record, index) => {
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td>
                          <div className={`badge badge-lg ${getAQIBadgeClass(recordAqi)}`}>
                            {recordAqi}
                          </div>
                        </td>
                      </tr>
